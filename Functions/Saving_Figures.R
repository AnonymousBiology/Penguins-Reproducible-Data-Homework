...
save_adelie_culmen_depth_body_mass_plot_svg <- function() {
  ggsave("Figures/adelie_culmen_depth_body_mass_plot.svg", plot = adelie_culmen_depth_body_mass_plot, width = 8, height = 6)
}

save_adelie_culmen_depth_body_mass_plot_png <- function() {
  ggsave("Figures/adelie_culmen_depth_body_mass_plot.png", plot = adelie_culmen_depth_body_mass_plot, width = 8, height = 6, dpi = 600)
}

save_adelie_culmen_depth_body_mass_plot_regression_svg <- function() {
  ggsave("Figures/adelie_culmen_depth_body_mass_plot_regression.svg", plot = adelie_culmen_depth_body_mass_plot_regression, width = 8, height = 6)
}

save_adelie_culmen_depth_body_mass_plot_regression_png <- function() {
  ggsave("Figures/adelie_culmen_depth_body_mass_plot_regression.png", plot = adelie_culmen_depth_body_mass_plot_regression, width = 8, height = 6, dpi = 600)
}